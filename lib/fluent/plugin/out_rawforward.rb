# coding: utf-8
module Fluent
  class RawForwardTCPOutput < BufferedOutput
    Plugin.register_output('rawforward', self)
    ...
    def configure(conf)
      ...
      conf.elements.each do |e|
        ...
        log.info "Forwarding server at '#{name}'", :host=>host, :port=>port
      end
    end
    ...
    def write(chunk)
      ...
      raise "No are no available nodes"
    end
